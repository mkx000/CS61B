...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> nodesOnTheWay;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            activeState = "node";
            GraphDB.Point p = new GraphDB.Point(Long.parseLong(attributes.getValue("id")), Double.parseDouble(attributes.getValue("lat")), Double.parseDouble(attributes.getValue("lon")));
            g.addNode(p);
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            if (isWayValid) {
                for (int i = 0; i < nodesOnTheWay.size() - 1; i++) {
                    g.addEdge(nodesOnTheWay.get(i), nodesOnTheWay.get(i + 1));
                }
                nodesOnTheWay.clear();
            }
            isWayValid = false;
